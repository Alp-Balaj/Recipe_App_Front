...
/**
 * GET /recipes via useInfiniteQuery. Each page's `nextCursor` is passed back
 * verbatim as `?cursor=`; a null nextCursor ends pagination. Changing the
 * queryKey resets pagination to page 1 automatically.
 */
export function useInfiniteRecipes({ queryKey, pageSize, query }: UseInfiniteRecipesOptions) {
