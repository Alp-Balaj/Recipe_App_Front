...
// Thin stub — checkpoint 02 replaces this with the real login form.
export default function LoginPage() {
  return (
    <div style={{ flex: '1 1 auto', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 18 }}>
      ...
      >
        <div style={{ fontSize: 22, fontWeight: 800, letterSpacing: '-0.01em' }}>Welcome back</div>
        <div style={{ fontSize: 13.5, color: 'var(--muted)', lineHeight: 1.5, margin: '6px 0 16px' }}>
          Signing in is coming in the next checkpoint.
        </div>
