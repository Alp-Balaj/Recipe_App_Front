...
export default function ThemeRoot() {
  // The imported redesign is light-native (warm cream/paper + gold); light is
  // the default open state. The toggle (Profile · Appearance, and the sidebar
  // moon) flips to the warm-charcoal dark variant and back.
